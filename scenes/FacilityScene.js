...
export default class FacilityScene extends Phaser.Scene {
  // I register FacilityScene so the game can navigate to this screen.
  constructor() {

    super('FacilityScene');
  }
  // I receive the facility title and its return destination.
  init(data) {
  ...
  // I identify this future town facility and provide a route back.
  create() {
