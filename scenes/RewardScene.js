...
export default class RewardScene extends Phaser.Scene {
  ...
  // This function registers RewardScene so the game can navigate to this
  // screen.
  constructor() {
  ...
  // This function displays the saved victory summary in separate result and
  // party-progress panels. It shows gold, completion time, leader rewards,
  // and adventurer gains, then provides a button to return to the world map.
  create() {

    const { width, height } = this.scale;

    // Read rewards already committed by the battle outcome; this screen only
    // presents them.
